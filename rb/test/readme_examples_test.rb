...
#      offline in seeded test mode (QuanhauApiDocsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "QuanhauApiDocs_sdk.rb")
  SDK_CLASS = "QuanhauApiDocsSDK"
