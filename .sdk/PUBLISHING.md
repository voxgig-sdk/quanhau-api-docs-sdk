...
|---|---|---|
| `ts/` | @voxgig-sdk/quanhau-api-docs-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/quanhau-api-docs-sdk \
      --repository voxgig-sdk/quanhau-api-docs-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/quanhau-api-docs-sdk` shows it, and
`npm trust revoke @voxgig-sdk/quanhau-api-docs-sdk --id=<id>` removes it.
