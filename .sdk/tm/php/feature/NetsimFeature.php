...
// QuanhauApiDocs SDK netsim feature
...
class QuanhauApiDocsNetsimFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _simulate(QuanhauApiDocsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(QuanhauApiDocsContext $ctx, array $applied): void
    {
        $client = $this->client;
