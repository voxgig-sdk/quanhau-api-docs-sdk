...
// QuanhauApiDocs SDK cache feature
...
class QuanhauApiDocsCacheFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _through(QuanhauApiDocsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
