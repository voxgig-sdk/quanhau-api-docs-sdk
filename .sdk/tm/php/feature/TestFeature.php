...
// QuanhauApiDocs SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class QuanhauApiDocsTestFeature extends QuanhauApiDocsBaseFeature
{
    ...
    public function init(QuanhauApiDocsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (QuanhauApiDocsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = QuanhauApiDocsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (QuanhauApiDocsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(QuanhauApiDocsContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = QuanhauApiDocsParam::call($ctx, $k);
