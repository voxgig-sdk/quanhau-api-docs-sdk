...
// QuanhauApiDocs SDK timeout feature
...
class QuanhauApiDocsTimeoutFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _with_timeout(QuanhauApiDocsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(QuanhauApiDocsContext $_ctx, float $ms): void
    {
        $client = $this->client;
