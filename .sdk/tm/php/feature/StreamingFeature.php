...
// QuanhauApiDocs SDK streaming feature
...
class QuanhauApiDocsStreamingFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _iterate(QuanhauApiDocsResult $result): \Generator
    {
    ...
    private function _streamable(QuanhauApiDocsContext $ctx): bool
    {
