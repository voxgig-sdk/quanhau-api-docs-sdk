...
// QuanhauApiDocs SDK pipeline test
//
...
{
    private static function utility(): QuanhauApiDocsUtility
    {
        return new QuanhauApiDocsUtility();
    }
    ...
    private static function ctx(array $over = []): QuanhauApiDocsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new QuanhauApiDocsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new QuanhauApiDocsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof QuanhauApiDocsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new QuanhauApiDocsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = QuanhauApiDocsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new QuanhauApiDocsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = QuanhauApiDocsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new QuanhauApiDocsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = QuanhauApiDocsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new QuanhauApiDocsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = QuanhauApiDocsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new QuanhauApiDocsResponse([]),
            'result' => new QuanhauApiDocsResult([]),
        ]);
        [, $err] = QuanhauApiDocsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new QuanhauApiDocsSpec([]),
            'response' => null,
            'result' => new QuanhauApiDocsResult([]),
        ]);
        [, $err] = QuanhauApiDocsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new QuanhauApiDocsSpec(['step' => 's']),
            'response' => new QuanhauApiDocsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new QuanhauApiDocsResult([]),
        ]);
        [, $err] = QuanhauApiDocsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new QuanhauApiDocsSpec(['step' => 's']),
            'response' => new QuanhauApiDocsResponse(self::resp(200, ['v' => 1])),
            'result' => new QuanhauApiDocsResult([]),
        ]);
        [, $err] = QuanhauApiDocsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new QuanhauApiDocsSpec(['step' => 's']),
            'response' => new QuanhauApiDocsResponse(self::resp(200, ['v' => 2])),
            'result' => new QuanhauApiDocsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        QuanhauApiDocsMakeResponse::call($ctx);
    ...
    {
        $preset = new QuanhauApiDocsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new QuanhauApiDocsSpec([]),
            'response' => new QuanhauApiDocsResponse([]),
            'result' => new QuanhauApiDocsResult([]),
        ...
        [$got, $err] = QuanhauApiDocsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new QuanhauApiDocsResult([])]);
        [, $err] = QuanhauApiDocsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new QuanhauApiDocsSpec([]), 'result' => null]);
        [, $err] = QuanhauApiDocsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new QuanhauApiDocsSpec(['step' => 's']),
            'result' => new QuanhauApiDocsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new QuanhauApiDocsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = QuanhauApiDocsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new QuanhauApiDocsSpec(['step' => 's']),
            'result' => new QuanhauApiDocsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new QuanhauApiDocsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = QuanhauApiDocsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new QuanhauApiDocsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new QuanhauApiDocsSpec([]),
            'result' => new QuanhauApiDocsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = QuanhauApiDocsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = QuanhauApiDocsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new QuanhauApiDocsError('boom', 'boom');
        $utility->fetcher = function (QuanhauApiDocsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new QuanhauApiDocsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = QuanhauApiDocsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (QuanhauApiDocsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = QuanhauApiDocsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(QuanhauApiDocsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        QuanhauApiDocsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (QuanhauApiDocsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new QuanhauApiDocsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = QuanhauApiDocsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new QuanhauApiDocsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new QuanhauApiDocsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = QuanhauApiDocsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = QuanhauApiDocsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = QuanhauApiDocsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new QuanhauApiDocsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, QuanhauApiDocsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new QuanhauApiDocsResult(['ok' => false])]);
        $this->expectException(QuanhauApiDocsError::class);
        QuanhauApiDocsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new QuanhauApiDocsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', QuanhauApiDocsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        QuanhauApiDocsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new QuanhauApiDocsBaseFeature();
        $b = new QuanhauApiDocsBaseFeature();
        QuanhauApiDocsFeatureAdd::call($ctx, $a);
        QuanhauApiDocsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): QuanhauApiDocsBaseFeature
    {
        $f = new QuanhauApiDocsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        QuanhauApiDocsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): QuanhauApiDocsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new QuanhauApiDocsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = QuanhauApiDocsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        QuanhauApiDocsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new QuanhauApiDocsResponse(['headers' => null]),
            'result' => new QuanhauApiDocsResult([]),
        ]);
        QuanhauApiDocsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        QuanhauApiDocsResultBody::call($ctx);
