...
// QuanhauApiDocs SDK utility type

class QuanhauApiDocsUtility
{
    ...
    public static function copy(QuanhauApiDocsUtility $src): QuanhauApiDocsUtility
    {
        $u = new QuanhauApiDocsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
