...
// QuanhauApiDocs SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class QuanhauApiDocsTransformResponse
{
    public static function call(QuanhauApiDocsContext $ctx): mixed
    {
        ...
        $transform = QuanhauApiDocsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
