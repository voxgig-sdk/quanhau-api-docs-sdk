...
// QuanhauApiDocs SDK utility: make_options

class QuanhauApiDocsMakeOptions
{
    ...
    public static function call(QuanhauApiDocsContext $ctx): array
    {
        ...
        //
        // `QuanhauApiDocsSchema::optspec()` is built from the model:
        ...
        $optspec = QuanhauApiDocsSchema::optspec();
