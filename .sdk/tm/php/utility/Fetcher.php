...
// QuanhauApiDocs SDK utility: fetcher

class QuanhauApiDocsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; QuanhauApiDocsSDK/1.0)';
    ...
    public static function call(QuanhauApiDocsContext $ctx, string $fullurl, array $fetchdef): array
    {
