...
function envOverride(m) {
    if ('TRUE' === process.env.QUANHAU_API_DOCS_TEST_LIVE ||
        'TRUE' === process.env.QUANHAU_API_DOCS_TEST_OVERRIDE) {
    ...
    m.QUANHAU_API_DOCS_TEST_EXPLAIN = process.env.QUANHAU_API_DOCS_TEST_EXPLAIN || m.QUANHAU_API_DOCS_TEST_EXPLAIN;
    return m;
}
