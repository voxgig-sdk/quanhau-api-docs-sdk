...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.QUANHAUAPIDOCS_TEST_LIVE ||
    'TRUE' === process.env.QUANHAUAPIDOCS_TEST_OVERRIDE
  ) {
  ...
  m.QUANHAUAPIDOCS_TEST_EXPLAIN = process.env.QUANHAUAPIDOCS_TEST_EXPLAIN || m.QUANHAUAPIDOCS_TEST_EXPLAIN
