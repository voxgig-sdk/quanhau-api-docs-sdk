...
func registerSDKWords(r *eng.Registry, client *sdk.QuanhauApiDocsSDK) {
...
func runOp(client *sdk.QuanhauApiDocsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
