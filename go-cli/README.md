...
AQL-driven CLI and REPL for the QuanhauApiDocs SDK. Positional arguments are
...
```sh
go build -o quanhau-api-docs-cli ./...
```
...
./quanhau-api-docs-cli list api
./quanhau-api-docs-cli load 1 api
./quanhau-api-docs-cli load '{id:1}' api
