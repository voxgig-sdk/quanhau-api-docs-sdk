// Command QuanhauApiDocs-cli is a CLI + REPL for the QuanhauApiDocs SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      QUANHAU_API_DOCS_APIKEY (api key), QUANHAU_API_DOCS_BASE (base url override)")
