...
// instead of `sdk.NewQuanhauApiDocsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *QuanhauApiDocsSDK  { return NewQuanhauApiDocsSDK(nil) }
func Test() *QuanhauApiDocsSDK { return TestSDK(nil, nil) }
