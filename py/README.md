...
The Python SDK for the QuanhauApiDocs API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/quanhau-api-docs-sdk/releases)) or
