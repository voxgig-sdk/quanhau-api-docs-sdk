# QuanhauApiDocs SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions QuanhauApiDocsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both QuanhauApiDocsSDK(...) and QuanhauApiDocsSDK.test(...) become
#      QuanhauApiDocsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "quanhauapidocs_sdk"
_SDK_CLASS = "QuanhauApiDocsSDK"
