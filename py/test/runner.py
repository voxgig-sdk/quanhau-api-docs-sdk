...
class QuanhauApiDocsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QuanhauApiDocsTestRunner.getenv("QUANHAUAPIDOCS_TEST_LIVE")
        override = QuanhauApiDocsTestRunner.getenv("QUANHAUAPIDOCS_TEST_OVERRIDE")
        ...
        explain = QuanhauApiDocsTestRunner.getenv("QUANHAUAPIDOCS_TEST_EXPLAIN")
