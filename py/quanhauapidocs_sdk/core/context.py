...
from quanhauapidocs_sdk.core.helpers import get_ctx_prop, to_map
...
class QuanhauApiDocsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = QuanhauApiDocsControl()
        ...
        if isinstance(sp, QuanhauApiDocsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, QuanhauApiDocsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, QuanhauApiDocsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return QuanhauApiDocsOperation({})
    ...
    def make_error(self, code, msg):
        return QuanhauApiDocsError(code, msg, self)
