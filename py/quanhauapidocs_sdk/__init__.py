...
from quanhauapidocs_sdk.utility import register

# Load features
from quanhauapidocs_sdk.feature.base_feature import QuanhauApiDocsBaseFeature
from quanhauapidocs_sdk.features import _has_feature, _make_feature
...
class QuanhauApiDocsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = QuanhauApiDocsUtility()
        self._utility = utility

        from quanhauapidocs_sdk.config import shared_config
    ...
    def get_utility(self):
        return QuanhauApiDocsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("QuanhauApiDocsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from quanhauapidocs_sdk.entity.api_entity import ApiEntity
        return ApiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "QuanhauApiDocsSDK":
        if sdkopts is None:
            sdkopts = {}
