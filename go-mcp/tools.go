...
type Args struct {
	Entity string         `json:"entity" jsonschema:"api"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.QuanhauApiDocsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "quanhau-api-docs_list",
		Description: "List records from QuanhauApiDocs. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "quanhau-api-docs_load",
		Description: "Load a single record from QuanhauApiDocs. " +
...
func runOp(client *sdk.QuanhauApiDocsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.QuanhauApiDocsSDK, name string) (sdk.QuanhauApiDocsEntity, error) {
