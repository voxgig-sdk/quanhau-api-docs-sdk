...
// QuanhauApiDocs SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = QuanhauApiDocsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(QuanhauApiDocsOmni::structfix($now, Struct::undef()))
                        !== json_encode(QuanhauApiDocsOmni::structfix($val, Struct::undef()))) {
