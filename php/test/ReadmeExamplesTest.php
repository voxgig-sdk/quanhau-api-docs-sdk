...
// QuanhauApiDocs SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (QuanhauApiDocsSDK::test)
...
{
    private const SDK_CLASS = 'QuanhauApiDocsSDK';
    ...
    private const SDK_BASE = 'quanhauapidocs_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../quanhauapidocs_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
