...
// QuanhauApiDocs SDK utility: graphql
//
...
class QuanhauApiDocsGraphql
{
    ...
    // equivalent.
    public static function body(QuanhauApiDocsContext $ctx): mixed
    {
    ...
    public static function errors(QuanhauApiDocsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
