...
// QuanhauApiDocs SDK proxy feature
...
class QuanhauApiDocsProxyFeature extends QuanhauApiDocsBaseFeature
{
    ...
    public function init(QuanhauApiDocsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (QuanhauApiDocsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
