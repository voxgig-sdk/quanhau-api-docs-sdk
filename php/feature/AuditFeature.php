...
// QuanhauApiDocs SDK audit feature
...
class QuanhauApiDocsAuditFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _emit(QuanhauApiDocsContext $ctx, string $outcome): void
    {
