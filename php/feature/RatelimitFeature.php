...
// QuanhauApiDocs SDK ratelimit feature
...
class QuanhauApiDocsRatelimitFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _acquire(QuanhauApiDocsContext $ctx): void
    {
    ...
    private function _track(QuanhauApiDocsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
