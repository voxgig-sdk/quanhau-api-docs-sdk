...
// QuanhauApiDocs SDK metrics feature
...
class QuanhauApiDocsMetricsFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _record(QuanhauApiDocsContext $ctx, bool $ok): void
    {
