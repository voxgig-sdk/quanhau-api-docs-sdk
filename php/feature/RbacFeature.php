...
// QuanhauApiDocs SDK rbac feature
...
class QuanhauApiDocsRbacFeature extends QuanhauApiDocsBaseFeature
{
    ...
    private function _required(QuanhauApiDocsContext $ctx): ?string
    {
    ...
    private function _reject(QuanhauApiDocsContext $ctx, string $required): void
    {
    ...
    private function _track(QuanhauApiDocsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
