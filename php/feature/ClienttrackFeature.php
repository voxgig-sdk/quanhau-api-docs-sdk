...
// QuanhauApiDocs SDK clienttrack feature
...
class QuanhauApiDocsClienttrackFeature extends QuanhauApiDocsBaseFeature
{
    ...
    public function PostConstruct(QuanhauApiDocsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'QuanhauApiDocs-SDK';
