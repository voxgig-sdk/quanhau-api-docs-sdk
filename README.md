...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/quanhau-api-docs` | `npm install @voxgig-sdk/quanhau-api-docs` |
| Python | `voxgig-sdk-quanhau-api-docs` | `pip install voxgig-sdk-quanhau-api-docs` |
| PHP | `voxgig-sdk/quanhau-api-docs` | `composer require voxgig-sdk/quanhau-api-docs` |
| Golang | `github.com/voxgig-sdk/quanhau-api-docs-sdk/go` | `go get github.com/voxgig-sdk/quanhau-api-docs-sdk/go` |
| Ruby | `voxgig-sdk-quanhau-api-docs` | `gem install voxgig-sdk-quanhau-api-docs` |
| Lua | `voxgig-sdk-quanhau-api-docs` | `luarocks install voxgig-sdk-quanhau-api-docs` |
