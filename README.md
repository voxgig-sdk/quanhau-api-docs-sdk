...
This API documentation serves as a comprehensive guide for developers to understand and integrate with the services offered by QuanHau, a fullstack web developer.

Learn more about QuanHau API Docs at [keyherlyswar.x10.mx](https://keyherlyswar.x10.mx).

This is an unofficial SDK for the QuanHau API Docs public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/quanhau-api-docs-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/quanhau-api-docs-sdk/tags) |
| Python | `voxgig-sdk-quanhau-api-docs` | publish pending — [install from git tag](https://github.com/voxgig-sdk/quanhau-api-docs-sdk/tags) |
| PHP | `voxgig-sdk/quanhau-api-docs` | publish pending — [install from git tag](https://github.com/voxgig-sdk/quanhau-api-docs-sdk/tags) |
| Golang | `github.com/voxgig-sdk/quanhau-api-docs-sdk/go` | `go get github.com/voxgig-sdk/quanhau-api-docs-sdk/go@latest` |
| Ruby | `voxgig-sdk-quanhau-api-docs` | publish pending — [install from git tag](https://github.com/voxgig-sdk/quanhau-api-docs-sdk/tags) |
| Lua | `voxgig-sdk-quanhau-api-docs` | publish pending — [install from git tag](https://github.com/voxgig-sdk/quanhau-api-docs-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/quanhau-api-docs-sdk/go-cli` | `go install github.com/voxgig-sdk/quanhau-api-docs-sdk/go-cli/cmd/quanhau-api-docs@latest` |
| Go MCP server | `github.com/voxgig-sdk/quanhau-api-docs-sdk/go-mcp` | `go get github.com/voxgig-sdk/quanhau-api-docs-sdk/go-mcp@latest` |
...
- Upstream API: [https://keyherlyswar.x10.mx/](https://keyherlyswar.x10.mx/)
