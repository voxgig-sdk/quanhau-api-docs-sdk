...
| --- | --- | --- | --- |
| Api | `load` | `GET /api` | See reference |

## Connect to the API

- Production server: `https://keyherlyswar.x10.mx`
...
- `quanhau-api-docs_list`: List records for an entity. No active entity supports this operation.
- `quanhau-api-docs_load`: Load one record for an entity. Supported entities: `api`.
